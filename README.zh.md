...
本仓库已从 IssueOracle 改名为 DetectorOracle。公开文档、安装命令、skill 名称和构建产物已经切换到 **DetectorOracle**。为了降低迁移风险，内部 Python 入口暂时仍保留为 `skills/issueoracle/scripts/issueoracle.py`。
