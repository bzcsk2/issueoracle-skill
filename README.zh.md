...
本仓库已从 IssueOracle 改名为 DetectorOracle。公开文档、安装命令、skill 名称、构建产物和公开 Python 入口已经切换到 **DetectorOracle**。旧入口 `skills/detectoracle/scripts/issueoracle.py` 仍作为兼容入口保留。
