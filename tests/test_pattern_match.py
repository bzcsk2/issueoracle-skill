...
class PatternMatchTests(unittest.TestCase):
    def setUp(self):
        ...
        self.chunk = schema.CodeChunk(
            file="test.py", start_line=1, end_line=10,
            symbol="test_func", language="Python",
    ...
    def test_match_signals_miss(self):
        chunk = schema.CodeChunk(
            file="other.py", start_line=1, end_line=5,
            symbol="other", language="Python",
            code_excerpt="x = 1 + 2",
        )
    ...
    def test_trigger_coverage_empty(self):
        pattern = schema.Pattern(
            id="no-trigger", title="No Trigger", language="Python",
